...
})({"ahq7e":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "f490db24c83bc4fc";
"use strict";
...
},{}],"97hsZ":[function(require,module,exports,__globalThis) {
...
var _scrollTriggerJs = require("gsap/ScrollTrigger.js");
(0, _gsap.gsap).registerPlugin((0, _scrollTriggerJs.ScrollTrigger));
window.onload = ()=>{
...
locoScroll.on("scroll", (0, _scrollTriggerJs.ScrollTrigger).update);
(0, _scrollTriggerJs.ScrollTrigger).scrollerProxy(scroller, {
    scrollLeft (value) {
...
(0, _scrollTriggerJs.ScrollTrigger).defaults({
    scroller: scroller
});
(0, _scrollTriggerJs.ScrollTrigger).addEventListener("refresh", ()=>locoScroll.update());
(0, _scrollTriggerJs.ScrollTrigger).refresh();
...
(0, _scrollTriggerJs.ScrollTrigger).scrollerProxy("[data-scroll-container]", {
    scrollTop (value) {
...
},{"./cursor":"3kBc4","gsap":"fPSuC","locomotive-scroll":"iDXE3","gsap/ScrollTrigger.js":"7wnFk","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3kBc4":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _gsap = require("gsap");
var _utils = require("./utils");
var _customEase = require("gsap/CustomEase");
(0, _gsap.gsap).registerPlugin((0, _customEase.CustomEase));
let mouse = {
    x: 0,
    y: 0
};
...
class Cursor {
    ...
    onScaleMouse() {
        this.Item.forEach((link)=>{
            if (link.matches(":hover")) this.ScaleCursor(this.Cursor.children[0], 0.8);
    ...
    onTurn() {
        this.Item.forEach((link)=>{
            if (link.matches(":hover")) this.Turn(this.Cursor.children[0], 90);
            link.addEventListener("mouseenter", ()=>{
    ...
    onTurn180() {
        this.Item.forEach((link)=>{
            if (link.matches(":hover")) this.Turn180(this.Cursor.children[0], 90);
    ...
    render() {
        ...
        for(const key in this.cursorConfigs)this.cursorConfigs[key].previous = (0, _utils.lerp)(this.cursorConfigs[key].previous, this.cursorConfigs[key].current, this.cursorConfigs[key].amt);
        this.Cursor.style.transform = `translateX(${this.cursorConfigs.x.previous}px) translateY(${this.cursorConfigs.y.previous}px)`;
        requestAnimationFrame(()=>this.render());
    }
}
exports.default = Cursor;
(0, _customEase.CustomEase).create("turn", "M0,0 C0,0 0.04558,0.23117 0.08199,0.37794 0.10829,0.48396 0.12444,0.54527 0.16029,0.6461 0.18757,0.72283 0.20762,0.77159 0.24642,0.84045 0.27617,0.89323 0.30417,0.92564 0.34356,0.97128 0.36143,0.99198 0.37737,1.00291 0.40024,1.01868 0.42257,1.03408 0.43842,1.04303 0.46324,1.0538 0.48854,1.06479 0.50619,1.07047 0.53323,1.07644 0.56201,1.08278 0.58189,1.08736 0.6109,1.08638 0.67772,1.08411 0.72458,1.08233 0.79034,1.06773 0.87065,1.0499 1,1 1,1 ");

},{"gsap":"fPSuC","./utils":"eYK4L","gsap/CustomEase":"1y1UF","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fPSuC":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eYK4L":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1y1UF":[function(require,module,exports,__globalThis) {
/*!
 * CustomEase 3.12.5
 * https://gsap.com
 *
...
},{"./utils/paths.js":"kjzT8","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kjzT8":[function(require,module,exports,__globalThis) {
/*!
 * paths 3.12.5
 * https://gsap.com
 *
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iDXE3":[function(require,module,exports,__globalThis) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["ahq7e","97hsZ"], "97hsZ", "parcelRequire94c2")

//# sourceMappingURL=index.c83bc4fc.js.map
